...
asm/overlays/rom_7ac2d8/ovl_f84_a_c_c_c_c_a_c.o: src/overlays/rom_7ac2d8/ovl_f84_a_c_c_c_c_a_c.c
	$(GCC296_CC) $(CSE_CFLAGS) -S -o $(@:.o=.s) $<
	printf '\n\t.text\n\t.align\t2, 0\n' >> $(@:.o=.s)
	arm-none-eabi-as -mcpu=arm7tdmi -mthumb-interwork -Iinclude -o $@ $(@:.o=.s)
...
asm/overlays/rom_797990/ovl_314_c_c_a_a_c_c_a_c_c_a_a_c.o: src/overlays/rom_797990/ovl_314_c_c_a_a_c_c_a_c_c_a_a_c.c
	$(GCC296_CC) $(CSE_CFLAGS) -S -o $(@:.o=.s) $<
	printf '\n\t.text\n\t.align\t2, 0\n' >> $(@:.o=.s)
	arm-none-eabi-as -mcpu=arm7tdmi -mthumb-interwork -Iinclude -o $@ $(@:.o=.s)
...
# OvlFunc_968_2009808 sits in the SAME mis-scoped rom_7f2f14/ovl_30_c_a_c_a_c_c%
# wildcard as OvlFunc_968_20096a4 above.  23 differing at -O1, 2 at -O2, EXACT at
# -O2.  It had been PARKED at the -O1 number, and the park note asserted that -O1
# was CORRECT for this TU -- see src/non_matching history.  Trusting
# makefile_flags is what entrenched that; the wildcard describes what the build
# WILL do, never what the TU SHOULD be screened at.
asm/overlays/rom_7f2f14/ovl_30_c_a_c_a_c_c_a_a_c_b.o: src/overlays/rom_7f2f14/ovl_30_c_a_c_a_c_c_a_a_c_b.c
	$(GCC296_CC) $(GCC296_CFLAGS) -S -o $(@:.o=.s) $<
	printf '\n\t.text\n\t.align\t2, 0\n' >> $(@:.o=.s)
	arm-none-eabi-as -mcpu=arm7tdmi -mthumb-interwork -Iinclude -o $@ $(@:.o=.s)
...
asm/overlays/rom_786f0c/ovl_30_c_c_c_c_c_c_c_c_c_c_c_c_b.o: src/overlays/rom_786f0c/ovl_30_c_c_c_c_c_c_c_c_c_c_c_c_b.c
	$(GCC296_CC) $(ALIAS_CFLAGS) -S -o $(@:.o=.s) $<
	printf '\n\t.text\n\t.align\t2, 0\n' >> $(@:.o=.s)
	arm-none-eabi-as -mcpu=arm7tdmi -mthumb-interwork -Iinclude -o $@ $(@:.o=.s)

asm/overlays/rom_7a5214/ovl_314_c_c_c_b.o: src/overlays/rom_7a5214/ovl_314_c_c_c_b.c
	$(GCC296_CC) $(ALIAS_CFLAGS) -S -o $(@:.o=.s) $<
	printf '\n\t.text\n\t.align\t2, 0\n' >> $(@:.o=.s)
	arm-none-eabi-as -mcpu=arm7tdmi -mthumb-interwork -Iinclude -o $@ $(@:.o=.s)
...
asm/overlays/rom_77dd1c/ovl_30_c_c_c_a_c_c_b.o: src/overlays/rom_77dd1c/ovl_30_c_c_c_a_c_c_b.c
	...
	printf '\n\t.text\n\t.align\t2, 0\n' >> $(@:.o=.s)
	arm-none-eabi-as -mcpu=arm7tdmi -mthumb-interwork -Iinclude -o $@ $(@:.o=.s)
# NARROWED (was a %-pattern over ovl_30_c_c_a_c_a, repeated 30 times).
# THE WILDCARD WAS WRONG THREE TIMES OUT OF FOUR.  It matched four TUs, and
# three of them -- _a_a_b, _a_c_b and _a_c_c_b -- each needed an explicit -O2
# override added after -O1 broke them, on three separate occasions.  A fourth
# split product, _a_a_c_b, would have needed a fourth.  Every split ever landed
# under this prefix wanted -O2; only ovl_30_c_c_a_c_a_b actually wants -O1, so
# it is named explicitly here and new split children fall to the tree default.
# This is the recurring prefix trap recorded above, removed at the source
# rather than overridden once more.
asm/overlays/rom_78603c/ovl_30_c_c_a_c_a_b.o: src/overlays/rom_78603c/ovl_30_c_c_a_c_a_b.c
	$(GCC296_CC) $(O1_CFLAGS) -S -o $(@:.o=.s) $<
	printf '\n\t.text\n\t.align\t2, 0\n' >> $(@:.o=.s)
	arm-none-eabi-as -mcpu=arm7tdmi -mthumb-interwork -Iinclude -o $@ $(@:.o=.s)
...
asm/overlays/rom_79e5c0/ovl_30_c_a_c.o: src/overlays/rom_79e5c0/ovl_30_c_a_c.c
	...
	printf '\n\t.text\n\t.align\t2, 0\n' >> $(@:.o=.s)
	arm-none-eabi-as -mcpu=arm7tdmi -mthumb-interwork -Iinclude -o $@ $(@:.o=.s)
asm/overlays/rom_79e5c0/ovl_30_c_a_a_c_a_a_a_c_c_a_b.o: src/overlays/rom_79e5c0/ovl_30_c_a_a_c_a_a_a_c_c_a_b.c
	$(GCC296_CC) $(GCSE_CFLAGS) -S -o $(@:.o=.s) $<
	printf '\n\t.text\n\t.align\t2, 0\n' >> $(@:.o=.s)
	arm-none-eabi-as -mcpu=arm7tdmi -mthumb-interwork -Iinclude -o $@ $(@:.o=.s)
asm/overlays/rom_7bf5a8/ovl_2e0_c_a_c.o: src/overlays/rom_7bf5a8/ovl_2e0_c_a_c.c
...
asm/overlays/rom_7bdeb0/ovl_d20_c_c_c_a_b.o: src/overlays/rom_7bdeb0/ovl_d20_c_c_c_a_b.c
	...
	printf '\n\t.text\n\t.align\t2, 0\n' >> $(@:.o=.s)
	arm-none-eabi-as -mcpu=arm7tdmi -mthumb-interwork -Iinclude -o $@ $(@:.o=.s)
# OvlFunc_950_20087b0: GetFlag/SetFlag same-id shape (33 differing at -O2).
asm/overlays/rom_7d5838/ovl_30_c_c_a_c_c_c.o: src/overlays/rom_7d5838/ovl_30_c_c_a_c_c_c.c
	$(GCC296_CC) $(CSE_CFLAGS) -S -o $(@:.o=.s) $<
	printf '\n\t.text\n\t.align\t2, 0\n' >> $(@:.o=.s)
	arm-none-eabi-as -mcpu=arm7tdmi -mthumb-interwork -Iinclude -o $@ $(@:.o=.s)
...
asm/overlays/rom_798dc4/ovl_314_a_c_a_a.o: src/overlays/rom_798dc4/ovl_314_a_c_a_a.c
	...
	printf '\n\t.text\n\t.align\t2, 0\n' >> $(@:.o=.s)
	arm-none-eabi-as -mcpu=arm7tdmi -mthumb-interwork -Iinclude -o $@ $(@:.o=.s)
# Three more GetFlag(id)/SetFlag(id) dispatchers.  Same commoning, same fix.
asm/overlays/rom_78b2ac/ovl_30_c_c_a_a_a.o: src/overlays/rom_78b2ac/ovl_30_c_c_a_a_a.c
	$(GCC296_CC) $(CSE_CFLAGS) -S -o $(@:.o=.s) $<
	printf '\n\t.text\n\t.align\t2, 0\n' >> $(@:.o=.s)
	arm-none-eabi-as -mcpu=arm7tdmi -mthumb-interwork -Iinclude -o $@ $(@:.o=.s)
...
asm/overlays/rom_78c76c/ovl_30_c_c_c_c_c_a_b.o: src/overlays/rom_78c76c/ovl_30_c_c_c_c_c_a_b.c
	...
	printf '\n\t.text\n\t.align\t2, 0\n' >> $(@:.o=.s)
	arm-none-eabi-as -mcpu=arm7tdmi -mthumb-interwork -Iinclude -o $@ $(@:.o=.s)
asm/overlays/rom_78c76c/ovl_30_c_c_c_c_c_a_c.o: src/overlays/rom_78c76c/ovl_30_c_c_c_c_c_a_c.c
	$(GCC296_CC) $(CSE_CFLAGS) -S -o $(@:.o=.s) $<
	printf '\n\t.text\n\t.align\t2, 0\n' >> $(@:.o=.s)
	arm-none-eabi-as -mcpu=arm7tdmi -mthumb-interwork -Iinclude -o $@ $(@:.o=.s)
asm/overlays/rom_7bf5a8/ovl_2e0_c_a_c.o: src/overlays/rom_7bf5a8/ovl_2e0_c_a_c.c
