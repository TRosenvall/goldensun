/* Cluster OvlFunc_common0_0..OvlFunc_common0_0 extracted from goldensun/asm/overlays/common/common0.s (via its _a piece).
 *
 * Total .text for this TU = 22 bytes (= 0x16).
 * First in the common0 run, ahead of the _a_b piece, in all NINETEEN overlay.ld scripts.
 *
...
void OvlFunc_common0_0(void *a, int v)
{
    struct Sprite *s;
