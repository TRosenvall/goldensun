/* OvlFunc_915_2008cf4  --  0x02008cf4, cut from goldensun/asm/overlays/rom_7a2bf0/ovl_30_c_c_c_a.s.
 *
 * Preserves the original ROM layout when slotted after
 * asm/overlays/rom_7a2bf0/ovl_30_c_c_c_a.o in goldensun/overlays/rom_7a2bf0/overlay.ld.
 *
...
unsigned short OvlFunc_915_2008cf4(unsigned short colour, int rate)
{
    short b, g, r;
