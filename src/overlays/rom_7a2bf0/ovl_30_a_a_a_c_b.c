/* Cluster OvlFunc_915_200806c..OvlFunc_915_200806c extracted from goldensun/asm/overlays/rom_7a2bf0/ovl_30_a_a_a_c_b.s.
 *
...
struct Ent *OvlFunc_915_200806c(struct Vec *pos)
{
    struct Ent **tbl;
    struct Ent *e;
    char *base;
