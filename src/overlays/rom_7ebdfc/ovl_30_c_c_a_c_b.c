/* Cluster OvlFunc_961_2008068..OvlFunc_961_2008068 extracted from goldensun/asm/overlays/rom_7ebdfc/ovl_30_c_c_a_c.s.
 *
 * Split out of that .s; the _c part stays as assembly.
 *
 ...
 *    as a plain 0x25b8 gcc folds each use into its own pool load and the
...
extern int _MSG_25b8;

void OvlFunc_961_2008068(int slot)
{
    int base = (int)(&_MSG_25b8);
