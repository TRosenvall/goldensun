/* OvlFunc_946_20080c4 -- TryPushBlockOneTile, overlay rom_7ced6c, ovl_30_a_a_a_c_c_a.
 *
 ...
 * source with three substitutions:  OvlFunc_946_20080c4 / .L315c / OvlFunc_946_200806c.
 *
 *   OK OvlFunc_946_20080c4 -- 384 bytes, 176 encodings and 14 relocations identical
 ...
 *   overlays/rom_7ced6c/overlay.ld:19
 *       asm/overlays/rom_7ced6c/ovl_30_a_a_a_c_c_a.o(.text)
 * `.L315c` is referenced here and defined in another object; it is ALREADY
 * `.global` in asm/overlays/rom_7ced6c/ovl_30_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_b.s -- grepped, no export to add.
 */
/* OvlFunc_946_20080c4  --  TryPushBlockOneTile, overlay 968 (rom_7f2f14),
 ...
 *   reach this stem.
 *   `.L315c` IS REFERENCED HERE AND DEFINED IN ANOTHER OBJECT -- and it is
 *   ALREADY EXPORTED: `.global .L315c` at
 ...
 *   OvlFunc_946_20080c4   rom_7f2f14/ovl_30_a_a_a_c_c_a_a_b.s            .L315c
 *
...
extern int L315c[] __asm__(".L315c");
...
extern struct Actor *OvlFunc_946_200806c(int *v, struct Actor *a);

void OvlFunc_946_20080c4(void)
{
    int v[3];
    struct Actor *p;
    struct Actor *b;
