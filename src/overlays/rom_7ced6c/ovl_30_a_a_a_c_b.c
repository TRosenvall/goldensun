/* Cluster OvlFunc_946_200806c..OvlFunc_946_200806c extracted from goldensun/asm/overlays/rom_7ced6c/ovl_30_a_a_a_c_b.s.
 *
...
struct Ent *OvlFunc_946_200806c(struct Vec *pos)
{
    struct Ent **tbl;
    struct Ent *e;
    char *base;
