/* Cluster OvlFunc_946_200a848..OvlFunc_946_200a848 extracted from goldensun/asm/overlays/rom_7ced6c/ovl_30_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_a_c_c_c_a_c_c_a.s.
 *
 * Total .text for this TU = 316 bytes.
 ...
 *
 * All constants here are POSITIVE, so there is no shared `neg` in the tail and
 * each arm carries its own full argument setup and `bl`. The chain also has no
 * trailing return arm: a failing `a == 0x12` falls straight through to the
 * common tail.
 */
