/* Cluster OvlFunc_946_2008ae8..OvlFunc_946_2008ae8 extracted from goldensun/asm/overlays/rom_7ced6c/ovl_30_a_a_c_c_c_c_c.s.
 *
...
extern void OvlFunc_946_2008ab0();
extern struct Def *L32d4[] __asm__(".L32d4");

void OvlFunc_946_2008ae8(int a, int b, int c, int d, int e, int f, int flags, struct P *p)
{
    struct Actor *a0;
    struct Actor *act;
    struct Sprite *spr;
    ...
    __Actor_SetScript(act, L32d4[flags & 0xf]);
    act->f55 = 0;
    spr->f26 = 0;
    act->fn = (void *)OvlFunc_946_2008ab0;
    act->dx = d;
    act->dy = e;
    act->dz = f;
    spr->sel = a0->spr->sel;
