/* Cluster OvlFunc_946_200a4c8..OvlFunc_946_200a4c8 extracted from goldensun/asm/overlays/rom_7ced6c/ovl_30_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_a_c_c_c_a.s.
 *
 * Total .text for this TU = 296 bytes.
...
void OvlFunc_946_200a4c8(void)
{
    ...
    if (a == 0x13) {
        ...
        } else if ((unsigned int)(d - 6) <= 2) {
            OvlFunc_946_2009774(0x12, 0, -0x40);
        } else if ((unsigned int)(c - 6) <= 2) {
        ...
        if ((unsigned int)(b - 6) <= 2)
            return;
        if ((unsigned int)(d - 6) <= 2)
            OvlFunc_946_2009774(0x12, 0, -0x30);
        else if ((unsigned int)(c - 6) <= 2)
            OvlFunc_946_2009774(0x12, 0, -0x60);
        else
            OvlFunc_946_2009774(0x12, 0, -0x90);
    } else if (a == 0xf) {
        if ((unsigned int)(d - 6) <= 2)
            return;
