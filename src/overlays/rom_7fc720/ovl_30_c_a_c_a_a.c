// fakematch
/* Cluster OvlFunc_973_200804c..OvlFunc_973_200804c extracted from goldensun/asm/overlays/rom_7fc720/ovl_30_c_a_c_a_a.s.
 *
...
extern void __MapActor_Emote(unsigned int a, unsigned int b, int c);
...
void OvlFunc_973_200804c(void)
{
    ...
    w = 0x81;
    {
        register unsigned int rq __asm__("r0") = 0xd;
        __asm__ volatile ("" : : "r" (rq));
        w <<= 1;
        __MapActor_Emote(rq, w, 0);
    }
