/* OvlFunc_891_200995c
 *
 * Cut out of goldensun/asm//overlays/rom_78c76c/ovl_30_c_c_a_c_c_c_c_a_c_c_b.s.
 *
 * Walks the guard and the player together once the player is far enough in.
 *
 * FOUR LEVERED LOCALS for two constants across two call sites -- one local per
 * site. -fno-rerun-cse-after-loop does NOT reach this one (44 differing with
 * the flag and literals), which is the expand-time hoist row of the batch-111
 * table rather than the CSE row.
 *
