/* Cluster OvlFunc_959_200806c..OvlFunc_959_200806c extracted from goldensun/asm/overlays/rom_7e7574/ovl_30_c_a_b.s.
 *
...
struct Ent *OvlFunc_959_200806c(struct Vec *pos)
{
    struct Ent **tbl;
    struct Ent *e;
    char *base;
