/* OvlFunc_927_200ac0c  --  0x0200ac0c, cut from
 * goldensun/asm/overlays/rom_7b4558/ovl_30_c_c_c_c.s.
 *
...
extern void OvlFunc_927_200aba4(void);

void OvlFunc_927_200ac0c(int slot)
{
    struct A *a;
    struct S *s;
    void *buf;
