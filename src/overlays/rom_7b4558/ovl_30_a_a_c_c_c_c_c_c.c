/* Cluster OvlFunc_927_2008ae8..OvlFunc_927_2008ae8 extracted from goldensun/asm/overlays/rom_7b4558/ovl_30_a_a_c_c_c_c_c_c.s.
 *
...
extern void OvlFunc_927_2008ab0();
extern struct Def *L3058[] __asm__(".L3058");

void OvlFunc_927_2008ae8(int a, int b, int c, int d, int e, int f, int flags, struct P *p)
{
    struct Actor *a0;
    struct Actor *act;
    struct Sprite *spr;
    ...
    __Actor_SetScript(act, L3058[flags & 0xf]);
    act->f55 = 0;
    spr->f26 = 0;
    act->fn = (void *)OvlFunc_927_2008ab0;
    act->dx = d;
    act->dy = e;
    act->dz = f;
    spr->sel = a0->spr->sel;
