/* OvlFunc_939_2009840  --  0x02009840, cut from
 * goldensun/asm/overlays/rom_7c460c/ovl_314_c_c.s.
 *
...
extern void OvlFunc_939_20097d8(void);

void OvlFunc_939_2009840(int slot)
{
    struct A *a;
    struct S *s;
    void *buf;
