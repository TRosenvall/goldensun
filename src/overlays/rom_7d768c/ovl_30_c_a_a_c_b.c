/* Cluster OvlFunc_952_2008524..OvlFunc_952_2008524 extracted from goldensun/asm/overlays/rom_7d768c/ovl_30_c_a_a_c.s.
 *
 * Preserves the original ROM layout when slotted between
 * asm/overlays/rom_7d768c/ovl_30_c_a_a_c_a.o and asm/overlays/rom_7d768c/ovl_30_c_a_a_c_c_b.o in
 ...
 *    folds an offset into a symbol address, so `_MSG_22a8` goes in message.sym --
 ...
 */
extern int _MSG_22a8;

extern void __MessageID(int id);
extern int __Func_8091c7c(int a, int b);
extern void __ActorMessage(int slot, int b);

void OvlFunc_952_2008524(int slot)
{
    int base = (int)(&_MSG_22a8);
