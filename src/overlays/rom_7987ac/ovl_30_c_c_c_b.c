/* Cluster OvlFunc_902_2008570..OvlFunc_902_2008570 extracted from goldensun/asm/overlays/rom_7987ac/ovl_30_c_c_c.s.
 *
 * Total .text for this TU = 98 bytes (= 0x62).
 * Placed in the run in goldensun/overlays/rom_7987ac/overlay.ld.
 *
 * Byte-identical to OvlFunc_899_200c698 in overlays/rom_794ac0; this C is shared verbatim, with only the symbol changed.
 *
...
void OvlFunc_902_2008570(int id)
{
    struct A *act;
    struct S *s;
    void *buf;
