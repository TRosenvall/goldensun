/* Cluster OvlFunc_957_200806c..OvlFunc_957_200806c extracted from goldensun/asm/overlays/rom_7e3e08/ovl_30_a_a_a_c_a_b.s.
 *
 * Split out of that .s; the sibling parts stay as assembly and keep their
 * slots in the overlay's linker script.
 *
 * FindEntityAtPosition, one of seventeen identical copies -- one per overlay,
...
struct Ent *OvlFunc_957_200806c(struct Vec *pos)
{
    struct Ent **tbl;
    struct Ent *e;
    char *base;
