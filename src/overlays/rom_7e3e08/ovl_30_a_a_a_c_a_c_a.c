/* OvlFunc_957_20080c4 -- TryPushBlockOneTile, overlay rom_7e3e08, ovl_30_a_a_a_c_a_c_a.
 *
 ...
 * source with three substitutions:  OvlFunc_957_20080c4 / .L3eb4 / OvlFunc_957_200806c.
 *
 *   OK OvlFunc_957_20080c4 -- 384 bytes, 176 encodings and 14 relocations identical
 ...
 *   overlays/rom_7e3e08/overlay.ld:19
 *       asm/overlays/rom_7e3e08/ovl_30_a_a_a_c_a_c_a.o(.text)
 * `.L3eb4` is referenced here and defined in another object; it is ALREADY
 * `.global` in asm/overlays/rom_7e3e08/ovl_30_c_c_c_c_b_c.s -- grepped, no export to add.
 */
/* OvlFunc_957_20080c4  --  TryPushBlockOneTile, overlay 968 (rom_7f2f14),
 ...
 *   reach this stem.
 *   `.L3eb4` IS REFERENCED HERE AND DEFINED IN ANOTHER OBJECT -- and it is
 *   ALREADY EXPORTED: `.global .L3eb4` at
 ...
 *   OvlFunc_957_20080c4   rom_7f2f14/ovl_30_a_a_a_c_c_a_a_b.s            .L3eb4
 *
...
extern int L3eb4[] __asm__(".L3eb4");
...
extern struct Actor *OvlFunc_957_200806c(int *v, struct Actor *a);

void OvlFunc_957_20080c4(void)
{
    int v[3];
    struct Actor *p;
    struct Actor *b;
