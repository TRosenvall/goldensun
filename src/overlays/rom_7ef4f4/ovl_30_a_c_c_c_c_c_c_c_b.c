/* OvlFunc_965_200a4d0
 *
 * Cut out of goldensun/asm//overlays/rom_7ef4f4/ovl_30_a_c_c_c_c_c_c_c_b.s.
 *
 * Moves the two guards aside once the gate flag is set.
 * Three levers: CSE_CFLAGS for the doubled flag-id pool load, the basic-block
 * lever for the first TravelTos shifted x, and the stack-arg pair named
 * adjacent. Only ONE of the two TravelTo sites is levered -- the second wants
 * the plain literal, which is the ROM saying so.
 *
