/* Cluster OvlFunc_965_20089f4..OvlFunc_965_20089f4 extracted from goldensun/asm/overlays/rom_7ef4f4/ovl_30_a_a_a_c_c_c_c.s.
 *
 * Total .text for this TU = 82 bytes (= 0x52).
 * Preserves the original ROM layout when slotted between the _a and _c pieces
 * of the same .s in goldensun/overlays/rom_7ef4f4/overlay.ld.
 *
 * ONE OF FOUR OPERAND-IDENTICAL COPIES, elevated together from a single source
 * with only the function name changed:
 *
 *      OvlFunc_927_20089f4   ovl_7b4558      OvlFunc_964_20089f4   ovl_7ed0a0
...
void *OvlFunc_965_20089f4(int a, int b, int c, int d)
{
    unsigned char *p;
    unsigned char *q;
    unsigned char *r;
