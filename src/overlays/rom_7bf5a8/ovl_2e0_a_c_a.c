/* OvlFunc_935_2008368 extracted from goldensun/asm/overlays/rom_7bf5a8/ovl_2e0_a_c_a.s.
 *
 ...
 *
 * 19 instructions against 17 without the flag. Near-twin of ovl_2e0_a_c_c.c.
 */
