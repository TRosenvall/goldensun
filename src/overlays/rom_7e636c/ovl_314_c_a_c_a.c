/* OvlFunc_958_20083a8 -- TryPushBlockOneTile, overlay rom_7e636c, ovl_314_c_a_c_a.
 *
 ...
 * source with three substitutions:  OvlFunc_958_20083a8 / .L16c0 / OvlFunc_958_2008350.
 *
 *   OK OvlFunc_958_20083a8 -- 384 bytes, 176 encodings and 14 relocations identical
 ...
 *   overlays/rom_7e636c/overlay.ld:24
 *       asm/overlays/rom_7e636c/ovl_314_c_a_c_a.o(.text)
 * `.L16c0` is referenced here and defined in another object; it is ALREADY
 * `.global` in asm/overlays/rom_7e636c/ovl_314_c_c_c_c.s -- grepped, no export to add.
 */
/* OvlFunc_958_20083a8  --  TryPushBlockOneTile, overlay 968 (rom_7f2f14),
 ...
 *   reach this stem.
 *   `.L16c0` IS REFERENCED HERE AND DEFINED IN ANOTHER OBJECT -- and it is
 *   ALREADY EXPORTED: `.global .L16c0` at
 ...
 *   OvlFunc_958_20083a8   rom_7f2f14/ovl_30_a_a_a_c_c_a_a_b.s            .L16c0
 *
...
extern struct Actor *OvlFunc_958_2008350(int *v, struct Actor *a);
