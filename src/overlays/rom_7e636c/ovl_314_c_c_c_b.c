// fakematch
/* Cluster OvlFunc_958_20088ec..OvlFunc_958_20088ec extracted from goldensun/asm/overlays/rom_7e636c/ovl_314_c_c_c.s.
 *
 * Total .text for this TU = 696 bytes (= 0x2b8).
 * Preserves the original ROM layout when slotted between
 * asm/overlays/rom_7e636c/ovl_314_c_c_c_a.o and asm/overlays/rom_7e636c/ovl_314_c_c_c_c.o in
 * goldensun/overlays/rom_7e636c/overlay.ld.
 */
extern unsigned char iwram_3001e70[];
extern int L1718[] __asm__(".L1718");
extern int L16c0[] __asm__(".L16c0");
extern void OvlFunc_958_200858c(void);
...
void OvlFunc_958_20088ec(struct Pk arg)
{
    ...
    *(int *)(__MapActor_GetActor(0) + 0x6c) = (int)OvlFunc_958_200858c;
    ...
    __Func_809228c(0, (short)(L16c0[dir] >> 16) / 2, (short)(L16c0[dir]) / 2);
    if (arg.arg5)
        arg.arg5();
    __MapActor_WaitMovement(0);
