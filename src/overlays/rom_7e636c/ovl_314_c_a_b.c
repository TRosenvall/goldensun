/* Cluster OvlFunc_958_2008350..OvlFunc_958_2008350 extracted from goldensun/asm/overlays/rom_7e636c/ovl_314_c_a_b.s.
 *
...
struct Ent *OvlFunc_958_2008350(struct Vec *pos)
{
    struct Ent **tbl;
    struct Ent *e;
    char *base;
