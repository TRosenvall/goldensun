/* Cluster OvlFunc_898_2008ecc..OvlFunc_898_2008ecc extracted from goldensun/asm/overlays/rom_793768/ovl_314_c_c_c_a_c_a_a_c_a.s.
 *
 * Preserves the original ROM layout when slotted between
 * asm/overlays/rom_793768/ovl_314_c_c_c_a_c_a_a_c_a_a.o and the rest of the
 * overlay in goldensun/overlays/rom_793768/overlay.ld.
 *
 * 0x17 appears three times here -- as both leading arguments and as the value
 * stored at [sp]. Only the stack one is named. The ROM materialises the other
 * two fresh with their own `mov`s, so naming them would produce register copies
 * that are not there; same reading as OvlFunc_935_2008410 in batch 31.
 *
