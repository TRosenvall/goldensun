 ...
 * ovl_30_a_c_c_a_a_a_a_b.c for why _ID_4f has to be a symbol rather than the
 * literal 0x4f, and unknown_id.sym for what is and is not being claimed about
 * the name.
 */
...
void OvlFunc_932_20083b4(void)
{
    ...
    gs[0x22b] = 3;
    __Func_8091f90((int) (&_ID_4f), 0x63);
