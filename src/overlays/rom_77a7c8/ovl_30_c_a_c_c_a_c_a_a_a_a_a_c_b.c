// fakematch
/* OvlFunc_881_2009680  --  0x02009680
 *
 ...
 *
 * TWINS: OvlFunc_881_200955c in the same .s is the same twelve-call sequence with a
 * different base constant (0xdf against 0xd9) and a different set of
 ...
 * argument with `mov r2, #0xd9 / lsl r2, #19`; the other eight load it from
 * the pool. 0xd9 << 19 is a shifted byte and Thumb can build it in two
 * instructions, while the others -- 0x6cc0000 and its neighbours -- are not, so
