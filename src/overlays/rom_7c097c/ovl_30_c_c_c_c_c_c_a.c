/* OvlFunc_936_200ba3c  --  0x0200ba3c, cut from
 * goldensun/asm/overlays/rom_7c097c/ovl_30_c_c_c_c_c_c.s.
 *
...
extern void OvlFunc_936_200b9d4(void);

void OvlFunc_936_200ba3c(int slot)
{
    struct A *a;
    struct S *s;
    void *buf;
