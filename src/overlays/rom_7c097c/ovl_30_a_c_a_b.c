/* Cluster OvlFunc_936_20080ac..OvlFunc_936_20080ac extracted from goldensun/asm/overlays/rom_7c097c/ovl_30_a_c_a.s.
 *
 * Total .text for this TU = 64 bytes (= 0x40).
 * Placed in the run in goldensun/overlays/rom_7c097c/overlay.ld.
 *
 * Byte-identical to OvlFunc_969_2008424 in overlays/rom_7f6e64; this C is shared
 * verbatim.
 *
...
int OvlFunc_936_20080ac(struct A *a)
{
    int t;
    int u;
    int v;
