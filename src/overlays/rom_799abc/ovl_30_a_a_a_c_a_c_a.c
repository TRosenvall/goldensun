/* OvlFunc_905_20080c4 -- TryPushBlockOneTile, overlay rom_799abc, ovl_30_a_a_a_c_a_c_a.
 *
 ...
 * source with three substitutions:  OvlFunc_905_20080c4 / .L1554 / OvlFunc_905_200806c.
 *
 *   OK OvlFunc_905_20080c4 -- 384 bytes, 176 encodings and 14 relocations identical
 ...
 *   overlays/rom_799abc/overlay.ld:19
 *       asm/overlays/rom_799abc/ovl_30_a_a_a_c_a_c_a.o(.text)
 * `.L1554` is referenced here and defined in another object; it is ALREADY
 * `.global` in asm/overlays/rom_799abc/ovl_30_c_c_c_c_c.s -- grepped, no export to add.
 */
/* OvlFunc_905_20080c4  --  TryPushBlockOneTile, overlay 968 (rom_7f2f14),
 ...
 *   reach this stem.
 *   `.L1554` IS REFERENCED HERE AND DEFINED IN ANOTHER OBJECT -- and it is
 *   ALREADY EXPORTED: `.global .L1554` at
 ...
 *   OvlFunc_905_20080c4   rom_7f2f14/ovl_30_a_a_a_c_c_a_a_b.s            .L1554
 *
...
extern int L1554[] __asm__(".L1554");
...
extern struct Actor *OvlFunc_905_200806c(int *v, struct Actor *a);
