/* Cluster OvlFunc_964_20089f4..OvlFunc_964_20089f4 extracted from goldensun/asm/overlays/rom_7ed0a0/ovl_30_a_a_a_c_c_c_c.s.
 *
 * Total .text for this TU = 82 bytes (= 0x52).
 * Preserves the original ROM layout when slotted between the _a and _c pieces
 * of the same .s in goldensun/overlays/rom_7ed0a0/overlay.ld.
 *
...
void *OvlFunc_964_20089f4(int a, int b, int c, int d)
{
    unsigned char *p;
    unsigned char *q;
    unsigned char *r;
