/* Cluster OvlFunc_964_2008ab0..OvlFunc_964_2008ab0 extracted from goldensun/asm/overlays/rom_7ed0a0/ovl_30_a_a_a_c_c_c_c_c.s.
 *
 * Total .text for this TU = 54 bytes (= 0x36).
 * Slotted between the _a and _c pieces in goldensun/overlays/rom_7ed0a0/overlay.ld.
 *
...
void OvlFunc_964_2008ab0(struct S *p)
{
    p->x += p->dx;
    p->y += p->dy;
    p->z += p->dz;
