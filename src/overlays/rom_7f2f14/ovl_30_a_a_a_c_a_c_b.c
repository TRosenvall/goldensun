/* Cluster OvlFunc_968_20080e0..OvlFunc_968_20080e0 extracted from goldensun/asm/overlays/rom_7f2f14/ovl_30_a_a_a_c_a_c.s.
 *
 * Total .text for this TU = 54 bytes (= 0x36).
 * Slotted between the _a and _c pieces in goldensun/overlays/rom_7f2f14/overlay.ld.
 *
...
void OvlFunc_968_20080e0(struct S *p)
{
    p->x += p->dx;
    p->y += p->dy;
    p->z += p->dz;
