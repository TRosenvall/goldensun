/* OvlFunc_968_2008374  --  TryPushBlockOneTile, overlay 968 (rom_7f2f14),
 * ovl_30_a_a_a_c_c_a_a_b.
 *
 * EXACT.  Re-run eight times:
 *
 *   OK OvlFunc_968_2008374 -- 384 bytes, 176 encodings and 14 relocations identical
 *
 * ===========================================================================
 ...
 *   reach this stem.
 *   `.L50e8` IS REFERENCED HERE AND DEFINED IN ANOTHER OBJECT -- and it is
 *   ALREADY EXPORTED: `.global .L50e8` at
 ...
 *   OvlFunc_968_2008374   rom_7f2f14/ovl_30_a_a_a_c_c_a_a_b.s            .L50e8
 *
...
extern int L50e8[] __asm__(".L50e8");
