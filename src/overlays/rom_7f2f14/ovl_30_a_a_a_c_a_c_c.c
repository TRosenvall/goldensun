/* OvlFunc_968_2008118 -- MATCHES on the default flags.
 * ref: asm/overlays/rom_7f2f14/ovl_30_a_a_a_c_a_c_c.s
...
extern void OvlFunc_968_20080e0(void);
extern struct Script *L51d4[] __asm__(".L51d4");

void OvlFunc_968_2008118(int x, int y, int z, int a, int b, int c,
                        unsigned int flags, struct Launch *p)
{
    ...
    if (n != 0) {
        ...
        __Actor_SetScript(n, (unsigned char *)L51d4[flags & 0xf]);
        n->f55 = 0;
        s->f26 = 0;
        n->f6c = OvlFunc_968_20080e0;
        n->f44 = a;
        n->f48 = b;
        n->f4c = c;
