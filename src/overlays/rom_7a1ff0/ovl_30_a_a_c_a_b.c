/* Cluster OvlFunc_914_200806c..OvlFunc_914_200806c extracted from goldensun/asm/overlays/rom_7a1ff0/ovl_30_a_a_c_a_b.s.
 *
...
struct Ent *OvlFunc_914_200806c(struct Vec *pos)
{
    struct Ent **tbl;
    struct Ent *e;
    char *base;
