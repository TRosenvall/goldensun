// fakematch
/* Cluster OvlFunc_914_2008608..OvlFunc_914_2008608 extracted from goldensun/asm/overlays/rom_7a1ff0/ovl_30_a_a_c_c_c.s.
 *
 * Total .text for this TU = 696 bytes (= 0x2b8).
 * Preserves the original ROM layout when slotted between
 * asm/overlays/rom_7a1ff0/ovl_30_a_a_c_c_c_a.o and asm/overlays/rom_7a1ff0/ovl_30_a_a_c_c_c_c.o in
 * goldensun/overlays/rom_7a1ff0/overlay.ld.
 */
extern unsigned char iwram_3001e70[];
extern int Lf20[] __asm__(".Lf20");
extern int Lec8[] __asm__(".Lec8");
extern void OvlFunc_914_20082a8(void);
...
void OvlFunc_914_2008608(struct Pk arg)
{
    ...
    *(int *)(__MapActor_GetActor(0) + 0x6c) = (int)OvlFunc_914_20082a8;
    ...
    __Func_809228c(0, (short)(Lec8[dir] >> 16) / 2, (short)(Lec8[dir]) / 2);
    if (arg.arg5)
        arg.arg5();
    __MapActor_WaitMovement(0);
