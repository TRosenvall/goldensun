/* OvlFunc_914_20080c4 -- TryPushBlockOneTile, overlay rom_7a1ff0, ovl_30_a_a_c_a_c_a.
 *
 ...
 * source with three substitutions:  OvlFunc_914_20080c4 / .Lec8 / OvlFunc_914_200806c.
 *
 *   OK OvlFunc_914_20080c4 -- 384 bytes, 176 encodings and 14 relocations identical
 ...
 *   overlays/rom_7a1ff0/overlay.ld:19
 *       asm/overlays/rom_7a1ff0/ovl_30_a_a_c_a_c_a.o(.text)
 * `.Lec8` is referenced here and defined in another object; it is ALREADY
 * `.global` in asm/overlays/rom_7a1ff0/ovl_30_c_c_c_c_c_c_c_b.s -- grepped, no export to add.
 */
/* OvlFunc_914_20080c4  --  TryPushBlockOneTile, overlay 968 (rom_7f2f14),
 ...
 *   reach this stem.
 *   `.Lec8` IS REFERENCED HERE AND DEFINED IN ANOTHER OBJECT -- and it is
 *   ALREADY EXPORTED: `.global .Lec8` at
 ...
 *   OvlFunc_914_20080c4   rom_7f2f14/ovl_30_a_a_a_c_c_a_a_b.s            .Lec8
 *
...
extern struct Actor *OvlFunc_914_200806c(int *v, struct Actor *a);

void OvlFunc_914_20080c4(void)
{
    int v[3];
    struct Actor *p;
    struct Actor *b;
