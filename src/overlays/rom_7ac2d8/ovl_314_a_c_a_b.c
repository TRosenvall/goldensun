/* Cluster OvlFunc_924_2008350..OvlFunc_924_2008350 extracted from goldensun/asm/overlays/rom_7ac2d8/ovl_314_a_c_a_b.s.
 *
...
struct Ent *OvlFunc_924_2008350(struct Vec *pos)
{
    struct Ent **tbl;
    struct Ent *e;
    char *base;
