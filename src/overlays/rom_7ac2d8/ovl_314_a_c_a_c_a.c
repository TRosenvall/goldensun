/* OvlFunc_924_20083a8 -- TryPushBlockOneTile, overlay rom_7ac2d8, ovl_314_a_c_a_c_a.
 *
 ...
 * source with three substitutions:  OvlFunc_924_20083a8 / .L5d50 / OvlFunc_924_2008350.
 *
 *   OK OvlFunc_924_20083a8 -- 384 bytes, 176 encodings and 14 relocations identical
 ...
 *   overlays/rom_7ac2d8/overlay.ld:24
 *       asm/overlays/rom_7ac2d8/ovl_314_a_c_a_c_a.o(.text)
 * `.L5d50` is referenced here and defined in another object; it is ALREADY
 * `.global` in asm/overlays/rom_7ac2d8/ovl_314_c_c.s -- grepped, no export to add.
 */
/* OvlFunc_924_20083a8  --  TryPushBlockOneTile, overlay 968 (rom_7f2f14),
 ...
 *   reach this stem.
 *   `.L5d50` IS REFERENCED HERE AND DEFINED IN ANOTHER OBJECT -- and it is
 *   ALREADY EXPORTED: `.global .L5d50` at
 ...
 *   OvlFunc_924_20083a8   rom_7f2f14/ovl_30_a_a_a_c_c_a_a_b.s            .L5d50
 *
...
extern struct Actor *OvlFunc_924_2008350(int *v, struct Actor *a);

void OvlFunc_924_20083a8(void)
{
    int v[3];
    struct Actor *p;
    struct Actor *b;
