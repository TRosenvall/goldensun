/* OvlFunc_924_2008cd0  --  0x02008cd0, cut from goldensun/asm/overlays/rom_7ac2d8/ovl_314_c.s.
 *
 * The .s held this function and a trailing data blob; the blob keeps its
 * slot as ovl_314_c_c.o and this file takes the .text line.
 ...
 *
 * One of TWO byte-identical copies -- OvlFunc_924_2008cd0 and OvlFunc_923_2008cc0.
...
int OvlFunc_924_2008cd0(struct Src *p)
{
    struct Emit s;
    unsigned int u;
    int k;
