/* OvlFunc_948_20080c4 -- TryPushBlockOneTile, overlay rom_7d30e0, ovl_30_a_a_a_c_a_c_a.
 *
 ...
 * source with three substitutions:  OvlFunc_948_20080c4 / .L2644 / OvlFunc_948_200806c.
 *
 *   OK OvlFunc_948_20080c4 -- 384 bytes, 176 encodings and 14 relocations identical
 ...
 *   overlays/rom_7d30e0/overlay.ld:19
 *       asm/overlays/rom_7d30e0/ovl_30_a_a_a_c_a_c_a.o(.text)
 * `.L2644` is referenced here and defined in another object; it is ALREADY
 * `.global` in asm/overlays/rom_7d30e0/ovl_30_c_c_c_c_c_c_c_c_c_c_c_c_c.s -- grepped, no export to add.
 */
/* OvlFunc_948_20080c4  --  TryPushBlockOneTile, overlay 968 (rom_7f2f14),
 ...
 *   reach this stem.
 *   `.L2644` IS REFERENCED HERE AND DEFINED IN ANOTHER OBJECT -- and it is
 *   ALREADY EXPORTED: `.global .L2644` at
 ...
 *   OvlFunc_948_20080c4   rom_7f2f14/ovl_30_a_a_a_c_c_a_a_b.s            .L2644
 *
...
extern int L2644[] __asm__(".L2644");
...
extern struct Actor *OvlFunc_948_200806c(int *v, struct Actor *a);

void OvlFunc_948_20080c4(void)
{
    int v[3];
    struct Actor *p;
    struct Actor *b;
