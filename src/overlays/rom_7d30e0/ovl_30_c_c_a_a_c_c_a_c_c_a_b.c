/* OvlFunc_948_2009b60
 *
 * Cut out of goldensun/asm//overlays/rom_7d30e0/ovl_30_c_c_a_a_c_c_a_c_c_a_b.s.
 *
 * Dispatches on where the player and the follower are standing, and on which
 * way the player faces. Matched on the first screen.
 *
