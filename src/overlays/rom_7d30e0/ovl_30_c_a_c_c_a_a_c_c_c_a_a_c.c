/* Cluster OvlFunc_948_200915c..OvlFunc_948_200915c extracted from goldensun/asm/overlays/rom_7d30e0/ovl_30_c_a_c_c_a_a_c_c_c_a_a.s.
 *
 * The .s held ONLY this function and no data after the split above it, so no
 * further split was needed. Twin of ovl_30_c_a_c_c_a_a_c_c_c_a_a_b.c, differing
 * only in the sub-state number.
 *
 * Runs sub-state 3, then -- only while the player's actor is in facing state
