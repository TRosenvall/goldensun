// fakematch
/* Cluster OvlFunc_934_20088ec..OvlFunc_934_20088ec extracted from goldensun/asm/overlays/rom_7bdeb0/ovl_314_a_a_c_c.s.
 *
 * Total .text for this TU = 696 bytes (= 0x2b8).
 * Preserves the original ROM layout when slotted between
 * asm/overlays/rom_7bdeb0/ovl_314_a_a_c_c_a.o and asm/overlays/rom_7bdeb0/ovl_314_a_a_c_c_c.o in
 * goldensun/overlays/rom_7bdeb0/overlay.ld.
 */
extern unsigned char iwram_3001e70[];
extern int L1ea0[] __asm__(".L1ea0");
extern int L1e48[] __asm__(".L1e48");
extern void OvlFunc_934_200858c(void);
...
void OvlFunc_934_20088ec(struct Pk arg)
{
    ...
    *(int *)(__MapActor_GetActor(0) + 0x6c) = (int)OvlFunc_934_200858c;
    ...
    __Func_809228c(0, (short)(L1e48[dir] >> 16) / 2, (short)(L1e48[dir]) / 2);
    if (arg.arg5)
        arg.arg5();
    __MapActor_WaitMovement(0);
