/* Cluster OvlFunc_934_2008350..OvlFunc_934_2008350 extracted from goldensun/asm/overlays/rom_7bdeb0/ovl_314_a_a_a_c_b.s.
 *
...
struct Ent *OvlFunc_934_2008350(struct Vec *pos)
{
    struct Ent **tbl;
    struct Ent *e;
    char *base;
