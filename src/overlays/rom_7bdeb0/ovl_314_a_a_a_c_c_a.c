/* OvlFunc_934_20083a8 -- TryPushBlockOneTile, overlay rom_7bdeb0, ovl_314_a_a_a_c_c_a.
 *
 ...
 * source with three substitutions:  OvlFunc_934_20083a8 / .L1e48 / OvlFunc_934_2008350.
 *
 *   OK OvlFunc_934_20083a8 -- 384 bytes, 176 encodings and 14 relocations identical
 ...
 *   overlays/rom_7bdeb0/overlay.ld:24
 *       asm/overlays/rom_7bdeb0/ovl_314_a_a_a_c_c_a.o(.text)
 * `.L1e48` is referenced here and defined in another object; it is ALREADY
 * `.global` in asm/overlays/rom_7bdeb0/ovl_314_c_c.s -- grepped, no export to add.
 */
/* OvlFunc_934_20083a8  --  TryPushBlockOneTile, overlay 968 (rom_7f2f14),
 ...
 *   reach this stem.
 *   `.L1e48` IS REFERENCED HERE AND DEFINED IN ANOTHER OBJECT -- and it is
 *   ALREADY EXPORTED: `.global .L1e48` at
 ...
 *   OvlFunc_934_20083a8   rom_7f2f14/ovl_30_a_a_a_c_c_a_a_b.s            .L1e48
 *
...
extern int L1e48[] __asm__(".L1e48");
...
extern struct Actor *OvlFunc_934_2008350(int *v, struct Actor *a);
