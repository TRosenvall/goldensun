/* OvlFunc_910_2008974  --  0x02008974, cut from
 * goldensun/asm/overlays/rom_79dd90/ovl_30_c_c_c_c_c.s.
 *
...
extern void OvlFunc_910_200890c(void);

void OvlFunc_910_2008974(int slot)
{
    struct A *a;
    struct S *s;
    void *buf;
