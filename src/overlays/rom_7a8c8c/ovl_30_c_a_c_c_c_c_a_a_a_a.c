/* Cluster OvlFunc_922_2009004..OvlFunc_922_2009004 extracted from goldensun/asm/overlays/rom_7a8c8c/ovl_30_c_a_c_c_c_c_a_a_a.s.
 *
 * Total .text for this TU = 74 bytes (= 0x4a).
 * Placed in the run in goldensun/overlays/rom_7a8c8c/overlay.ld.
 *
 * Byte-identical to OvlFunc_934_2009938 in overlays/rom_7bdeb0; this C is shared verbatim, with only the symbol changed.
 *
...
void OvlFunc_922_2009004(int slot, int x, int y)
{
    struct A *a;
    int k;
