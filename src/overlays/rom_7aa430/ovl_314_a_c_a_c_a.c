/* OvlFunc_923_20083a8 -- TryPushBlockOneTile, overlay rom_7aa430, ovl_314_a_c_a_c_a.
 *
 ...
 * source with three substitutions:  OvlFunc_923_20083a8 / .L2700 / OvlFunc_923_2008350.
 *
 *   OK OvlFunc_923_20083a8 -- 384 bytes, 176 encodings and 14 relocations identical
 ...
 *   overlays/rom_7aa430/overlay.ld:24
 *       asm/overlays/rom_7aa430/ovl_314_a_c_a_c_a.o(.text)
 * `.L2700` is referenced here and defined in another object; it is ALREADY
 * `.global` in asm/overlays/rom_7aa430/ovl_314_c_c.s -- grepped, no export to add.
 */
/* OvlFunc_923_20083a8  --  TryPushBlockOneTile, overlay 968 (rom_7f2f14),
 ...
 *   reach this stem.
 *   `.L2700` IS REFERENCED HERE AND DEFINED IN ANOTHER OBJECT -- and it is
 *   ALREADY EXPORTED: `.global .L2700` at
 ...
 *   OvlFunc_923_20083a8   rom_7f2f14/ovl_30_a_a_a_c_c_a_a_b.s            .L2700
 *
...
extern int L2700[] __asm__(".L2700");
...
extern struct Actor *OvlFunc_923_2008350(int *v, struct Actor *a);
