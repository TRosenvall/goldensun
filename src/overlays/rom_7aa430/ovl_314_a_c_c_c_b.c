// fakematch
/* Cluster OvlFunc_923_20088ec..OvlFunc_923_20088ec extracted from goldensun/asm/overlays/rom_7aa430/ovl_314_a_c_c_c.s.
 *
 * Total .text for this TU = 696 bytes (= 0x2b8).
 * Preserves the original ROM layout when slotted between
 * asm/overlays/rom_7aa430/ovl_314_a_c_c_c_a.o and asm/overlays/rom_7aa430/ovl_314_a_c_c_c_c.o in
 * goldensun/overlays/rom_7aa430/overlay.ld.
 */
extern unsigned char iwram_3001e70[];
extern int L2758[] __asm__(".L2758");
extern int L2700[] __asm__(".L2700");
extern void OvlFunc_923_200858c(void);
...
void OvlFunc_923_20088ec(struct Pk arg)
{
    ...
    *(int *)(__MapActor_GetActor(0) + 0x6c) = (int)OvlFunc_923_200858c;
    ...
    __Func_809228c(0, (short)(L2700[dir] >> 16) / 2, (short)(L2700[dir]) / 2);
    if (arg.arg5)
        arg.arg5();
    __MapActor_WaitMovement(0);
