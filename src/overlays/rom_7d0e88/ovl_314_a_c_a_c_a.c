/* OvlFunc_947_20083a8 -- TryPushBlockOneTile, overlay rom_7d0e88, ovl_314_a_c_a_c_a.
 *
 ...
 * source with three substitutions:  OvlFunc_947_20083a8 / .L2ca0 / OvlFunc_947_2008350.
 *
 *   OK OvlFunc_947_20083a8 -- 384 bytes, 176 encodings and 14 relocations identical
 ...
 *   overlays/rom_7d0e88/overlay.ld:24
 *       asm/overlays/rom_7d0e88/ovl_314_a_c_a_c_a.o(.text)
 * `.L2ca0` is referenced here and defined in another object; it is ALREADY
 * `.global` in asm/overlays/rom_7d0e88/ovl_314_c_c.s -- grepped, no export to add.
 */
/* OvlFunc_947_20083a8  --  TryPushBlockOneTile, overlay 968 (rom_7f2f14),
 ...
 *   reach this stem.
 *   `.L2ca0` IS REFERENCED HERE AND DEFINED IN ANOTHER OBJECT -- and it is
 *   ALREADY EXPORTED: `.global .L2ca0` at
 ...
 *   OvlFunc_947_20083a8   rom_7f2f14/ovl_30_a_a_a_c_c_a_a_b.s            .L2ca0
 *
...
extern int L2ca0[] __asm__(".L2ca0");
...
extern struct Actor *OvlFunc_947_2008350(int *v, struct Actor *a);

void OvlFunc_947_20083a8(void)
{
    int v[3];
    struct Actor *p;
    struct Actor *b;
