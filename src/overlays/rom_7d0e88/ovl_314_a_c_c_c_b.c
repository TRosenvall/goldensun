// fakematch
/* Cluster OvlFunc_947_20088ec..OvlFunc_947_20088ec extracted from goldensun/asm/overlays/rom_7d0e88/ovl_314_a_c_c_c.s.
 *
 * Total .text for this TU = 696 bytes (= 0x2b8).
 * Preserves the original ROM layout when slotted between
 * asm/overlays/rom_7d0e88/ovl_314_a_c_c_c_a.o and asm/overlays/rom_7d0e88/ovl_314_a_c_c_c_c.o in
 * goldensun/overlays/rom_7d0e88/overlay.ld.
 */
extern unsigned char iwram_3001e70[];
extern int gScript_884__0200acf8[];
extern int L2ca0[] __asm__(".L2ca0");
extern void OvlFunc_947_200858c(void);
...
void OvlFunc_947_20088ec(struct Pk arg)
{
    ...
    *(int *)(__MapActor_GetActor(0) + 0x6c) = (int)OvlFunc_947_200858c;
    ...
    __Func_809228c(0, (short)(L2ca0[dir] >> 16) / 2, (short)(L2ca0[dir]) / 2);
    if (arg.arg5)
        arg.arg5();
    __MapActor_WaitMovement(0);
