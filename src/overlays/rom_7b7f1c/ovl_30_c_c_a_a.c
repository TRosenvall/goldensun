/* Cluster OvlFunc_930_20080b8..OvlFunc_930_20080b8 extracted from goldensun/asm/overlays/rom_7b7f1c/ovl_30_c_c_a_a.s.
 *
...
extern int _AREA_4a;
extern unsigned char L1a38[] __asm__(".L1a38");
extern unsigned char L1918[] __asm__(".L1918");

unsigned char *OvlFunc_930_20080b8(void)
{
    unsigned int base;
    unsigned int off;
    ...
    base += off;
    off = 0;
    if (*(short *)((char *)base + off) == (int)(&_AREA_4a))
        return L1a38;
    return L1918;
}
