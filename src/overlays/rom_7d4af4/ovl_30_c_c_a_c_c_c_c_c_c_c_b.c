/* OvlFunc_949_2008644  --  0x02008644
 *
 * Cut out of goldensun/asm/overlays/rom_7d4af4/ovl_30_c_c_a_c_c_c_c_c_c_c.s.
 *
 ...
 * This one reads the entrance BEFORE playing the cue and subtracts 1 rather than 4 -- both read straight off the ROM's statement order.
 *
...
extern struct Entry L1d00[] __asm__(".L1d00");
...
void OvlFunc_949_2008644(void)
{
    ...
    ea = L1d00[n].a;
    eb = L1d00[n].b;
    __Func_8010560(L1d00[n].script, ea, eb);
