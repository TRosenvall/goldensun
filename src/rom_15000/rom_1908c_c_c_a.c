/* Cluster HuffStr_Start..HuffStr_Start extracted from goldensun/asm/rom_15000/rom_1908c_c_c.s.
 *
 * Total .text for this TU = 62 bytes (= 0x3e).
 * First in the run, ahead of the _b piece, in goldensun/stage1.ld; the _b piece
 * keeps the .rodata.
 *
 * Copies the ARM Huffman-string routine Func_8015570 into RAM, runs it on
 * the caller's two pointers, and frees the buffer.
 *
 ...
 * single `mov` -- and `_FUNC_8015570_SIZE` is emitted by `.func_end_emit_size` in
 * asm/rom_15000/rom_15430.s. See reports/batch-74.md for why that macro measures what it
 * does.
 */
...
extern void Func_8015570(void *a, void *b);
extern void free(void *p);
extern char _FUNC_8015570_SIZE[];
#define FUNC_8015570_SIZE ((u32) _FUNC_8015570_SIZE)

void HuffStr_Start(void *a, void *b)
{
    do {
        void (*func)(void *, void *) = Func_8004938(FUNC_8015570_SIZE);
        DMA3_SET(Func_8015570, func, 0x84000000 | (FUNC_8015570_SIZE / 4));
        do {
            func(a, b);
        } while (0);
        free(func);
