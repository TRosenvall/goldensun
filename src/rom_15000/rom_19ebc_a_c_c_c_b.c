/* Menu icons: load the move icon for a move.
 *
...
extern void LoadMoveIconID(s32 iconId, s32 a1, s32 a2, s32 a3, s32 a4);
 ...
 */
void LoadMoveIcon(s32 moveId, s32 a1, s32 a2, s32 a3, s32 a4)
{
    struct MoveInfo *info = _GetMoveInfo(moveId);

    LoadMoveIconID(info->iconId, a1, a2, a3, a4);
}
