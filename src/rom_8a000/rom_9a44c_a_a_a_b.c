/* Cluster Func_809a44c..Func_809a44c extracted from goldensun/asm/rom_8a000/rom_9a44c_a_a_a.s.
 *
 * Total .text for this TU = 54 bytes (= 0x36).
 * Placed ahead of the _c piece in goldensun/stage1.ld.
 *
