/* OvlFunc_970_20083c0  [ovl_7fa4ec]
 * Source asm: goldensun/asm/overlays/rom_7fa4ec/ovl_30_c_c_c.s
 *
 * Parked: logic faithful, does NOT byte-match (endgame permuter seed).
 * Candidate: work/loop9/OvlFunc_970_20083c0.c
...
extern unsigned int L180c __asm__(".L180c");

unsigned int OvlFunc_970_20083c0(void) {
    unsigned char *p = __MapActor_GetActor(0);
    L180c = *(unsigned int *)(p + 0xc);
    return 0;
}
