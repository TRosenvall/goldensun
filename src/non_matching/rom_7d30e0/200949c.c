/* OvlFunc_948_200949c -- 0x0200949c
 *
 * BLOCKER CLASS: see src/non_matching/rom_7d30e0/2009838.c, which analyses this
 ...
 * list. OvlFunc_948_200949c was picked up that way and re-derived from
