...
// Golden Sun 1: 8 channels / 21024 Hz == 0x0097F800. This is the single
// configuration delta from SA2's stock m4a (0x0093F500); see
// SAPPY_IMPORT_PLAN.md. Replaces SA2's COLLECT_RINGS / ENGINE conditionals.
#define DEFAULT_SOUND_MODE (SOUND_MODE_DA_BIT_8 | SOUND_MODE_FREQ_21024 | (15 << SOUND_MODE_MASVOL_SHIFT) | (8 << SOUND_MODE_MAXCHN_SHIFT))
