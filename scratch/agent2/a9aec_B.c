...
loop:
    ...
    if (m != 0) {
        ...
        switch (info[2]) {
        case 1:
            _Func_801e7c0(id + (int)&_MSG_182, win, 8, 8);
            break;
        case 2:
            _Func_801e7c0(id + (int)&_MSG_182, win, 8, 0x38);
            break;
        case 3:
            _Func_801e7c0(id + (int)&_MSG_182, win, 8, 0x28);
            break;
        case 4:
            _Func_801e7c0(id + (int)&_MSG_182, win, 8, 0x18);
            break;
        }
    }
    i--;
