...
ONLY one allowed to change it. You must NOT:
  ...
  * write anywhere except your own `scratch/agent2/` directory
...
2. Write your candidate C to `scratch/agent2/<name>.c`. Declare every callee
...
3. Screen it:
       docker run --rm -v "$PWD:/work" -w /work goldensun-build \
           python3 tools/tryc.py scratch/agent2/<name>.c --ref <path/to/.s> --full
