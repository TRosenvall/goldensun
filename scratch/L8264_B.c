...
void OvlFunc_938_2008264(void)
{
    ...
    case 9:
        if (__GetFlag(0x941)) {
            *(unsigned short *)(__MapActor_GetActor(8) + 6) = 0x80 << 5;
            if (__GetFlag(0x914) == 0)
                OvlFunc_938_2009494();
        } else {
            __MapActor_SetPos(9, 0, 0);
            if (__GetFlag(0x321)) {
                __MapActor_SetPos(8, 0x38a0000, 0xd3 << 17);
                *(unsigned short *)(__MapActor_GetActor(8) + 6) = 0xd0 << 8;
            }
        }
        break;
    case 0xa:
    case 0xb:
        if (__GetFlag(0x915)) {
            __CopyMapTiles(0x3a, 0x46, 0x36, 0x46, 4, 3);
            __Func_8010704(0x37, 9, 2, 1, 0x37, 8);
            __Func_800fe9c();
            __WaitFrames(1);
        }
        break;
