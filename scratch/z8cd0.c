...
extern int __TestCollision(unsigned char *a, unsigned char *b);
...
int OvlFunc_927_2008cd0(unsigned char *t)
{
    unsigned char *e;
    unsigned char *f;
    int saved;
    ...
    if (__TestCollision(e, t) == 0) {
        ...
        *f = *f & 0x7e;
        ...
        __Func_8092158(0, *(short *)(t + 2), *(short *)(t + 0xa));
        __Actor_SetAnim(e, 6);
