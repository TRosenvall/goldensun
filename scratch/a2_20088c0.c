...
extern unsigned char L319c[] __asm__(".L319c");
extern unsigned char L31b4[] __asm__(".L31b4");
...
int OvlFunc_946_20088c0(int slot)
{
    ...
    OvlFunc_946_2008244(0, v[2], v[4], w, h, 0xff);
    OvlFunc_946_2008244(2, v[2], v[4], w, h, 0xff);
    return 1;
}
