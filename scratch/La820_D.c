...
void OvlFunc_953_200a820(void)
{
    ...
    *(unsigned short *)(a + 6) = v;
    ...
    __MapActor_TravelTo(0, x1, y1);
    __Func_8092158(0xb, x2, y2);
    __MapActor_TravelTo(0, x3, y3);
    __Func_8092158(0xb, x4, y4);
    __MapActor_TravelTo(0, x5, y5);
    __MapActor_TravelTo(0xb, x6, y6);
    __MapTransitionOut();
    __WaitMapTransition();
    __Func_8091e9c(0x15);
}
