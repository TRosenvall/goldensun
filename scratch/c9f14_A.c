...
void OvlFunc_936_2009f14(void)
{
    switch (L5144) {
    case 0:
        *(unsigned short *)(__MapActor_GetActor(0x15) + 0x64) = 0;
        __MapActor_SetBehavior(0x15, gScript_936__0200bec0);
        L5144++;
        break;
    case 1:
        if (*(unsigned short *)(__MapActor_GetActor(0x15) + 0x64) == 0)
            return;
        *(unsigned short *)(__MapActor_GetActor(0x14) + 0x64) = 0;
        __MapActor_SetBehavior(0x14, gScript_936__0200bfb0);
        L5144++;
        break;
    case 2:
        if (*(unsigned short *)(__MapActor_GetActor(0x14) + 0x64) == 0)
            return;
        *(unsigned short *)(__MapActor_GetActor(0x14) + 0x64) = 0;
