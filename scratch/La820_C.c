...
void OvlFunc_953_200a820(void)
{
    ...
    *(unsigned short *)(a + 6) = v;
    ...
    __MapActor_TravelTo(0, 0xc8 << 2, y1);
    __Func_8092158(0xb, 0xc0 << 2, y2);
    __MapActor_TravelTo(0, 0xaf << 2, y3);
    __Func_8092158(0xb, 0xa7 << 2, y4);
    __MapActor_TravelTo(0, 0x96 << 2, y5);
    __MapActor_TravelTo(0xb, 0x8e << 2, y6);
    __MapTransitionOut();
    __WaitMapTransition();
    __Func_8091e9c(0x15);
}
