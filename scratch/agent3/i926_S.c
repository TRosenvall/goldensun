...
unsigned char *OvlFunc_926_2008388(void)
{
    ...
    if (__GetFlag(0x895) != 0) {
        q = L4998;
        *(unsigned short *)(q + 0x7a) = (int)(&_CONST_895);
        *(unsigned short *)(q + 0xaa) = (int)(&_CONST_895);
        *(int *)(q + 0xc8) = 0x1200000;
        *(int *)(q + 0xd0) = 0xf80000;
        *(unsigned short *)(q + 0x10a) = (int)(&_CONST_895);
        *(unsigned short *)(q + 0x122) = (int)(&_CONST_895);
    }
